...
<div class="card p-2 m-2">  
    <div class="card-body">
        <div class="row">
            <div class="col-md-3">
                <a class="btn btn-primary" href="<?php echo $sito ?>Area-Riservata/Aggiungi-Ced.html">Aggiungi CED</a>
            </div>
            <div class="col-md-9">
                <form action="<?php echo $sito ?>Area-Riservata/Ced.html" method="POST"> 
                    <div class="row justify-content-end">
                        <div class="col-auto">
                            <label for="cerca-operatore-ced" class="col-form-label">Cerca CED</label>
                        </div>
                        <div class="col-auto">
...
<div class="card p-2 m-2">
    <div class="card-title bg-dark text-white text-center"><h3>Lista CED</h3></div>
    <div class="card-body">
        ...
        $sql = "SELECT * FROM ced WHERE Sigla like concat('%', ?, '%') AND id != 0";
