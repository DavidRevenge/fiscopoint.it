<?php
    ...
    // titolo della pagina
    $titolo_pagina = "Modifica ufficio";    
    include("template/titolo_pagina.php");
    include("template/breadcrumb.php");
    
    $uffici_json = json_decode(file_get_contents("json/uffici.json"), true);    
    ...
    if(isset($_POST["oper"])){
        ...
        $val_par .= "i";
        $sql = "UPDATE uffici SET $set WHERE id = ?";
        ...
        <div class=\"alert alert-warning alert-dismissible fade show\" role=\"alert\">
            <strong>Ufficio {$_POST["Sigla"]} Modificato</strong>.
...
<form action="<?php echo $sito ?>Area-Riservata/Modifica-Ufficio-<?php echo $_GET["id"] ?>.html" method="POST">
    <?php
    foreach($uffici_json as $value) {
        $tmp = $row[$value["name"]];
        echo "
    ...
    <div class="m-1 m-md-2 row g-md-2 align-items-center">
        <div class="col-12 text-center">
            ...
            <button type="submit" class="btn btn-primary">Modifica Ufficio</button>
        </div>
    </div>
</form>